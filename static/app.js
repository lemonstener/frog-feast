  ...
  landingPage.innerHTML = `
    <div>
            ...
            <p>Welcome to Frog Feast ! Eat some bugs, get a high score and then do it all over again!<br> Watch out for bees though! Eat 3 bees and it's game over! <br> Oh yeah, you have a time limit too. <br> Press
                <span style="background-color: black; padding: 1.5px; border-radius: 5px; color:white">left</span> or
                <span style="background-color: black; padding: 1.5px; border-radius: 5px; color:white">right</span> on the 
                keyboard to stick your tongue out in that direction (or tap the screen on mobile).<br> 
                Press the <span style="background-color: black; padding: 1.5px; border-radius: 5px; color:white">spacebar</span> 
                to toggle the music on / off (or click on the
                <span
                    style="background-color: black; padding: 1.5px; border-radius: 5px; color:white">speaker</span>).
                    <br>
                    <span style="background-color: black; padding: 1.5px; border-radius: 5px; color:red">Flies</span> will get you 100 points, 
                    <span style="background-color: black; padding: 1.5px; border-radius: 5px; color:pink">Fluffly bugs</span> are worth 1000 and extend your 
                    timer but the <span style="background-color: black; padding: 2px; border-radius: 5px; color:gold">Bees</span> will hurt you.</p>
        ...
        <div class="enemies">
            <div style="margin-top:20px"><span style="background-color: black; padding: 2px; border-radius: 5px; color:red;">Fly</span></div>
            <div class="demo-fly"></div>
            <div style="margin-top:20px"><span style="background-color: black; padding: 2px; border-radius: 5px; color:gold">Bee</span></div>
            <div class="demo-bee"></div>
            <div style="margin-top:20px"><span style="background-color: black; padding: 2px; border-radius: 5px; color:pink">Fluffy Bug</span></div>
            <div class="demo-puffer"></div>
        </div>

        <div class="start"></div>
        <div style="background-color: rgba(51,51,51,.7); color:white; margin-top:3px;">
        <p>Winner of the Mintbean Star Award for "exemplary achievement in the field of web development". </p>
        </div>
